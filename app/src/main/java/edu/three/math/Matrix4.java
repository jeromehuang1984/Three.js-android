...
public class Matrix4 {
    ...
    public Matrix4 makePerspective(float left, float right, float top, float bottom,
    ...
    public Matrix4 makeOrthographic(float left, float right, float top, float bottom,
                                    float near, float far) {
